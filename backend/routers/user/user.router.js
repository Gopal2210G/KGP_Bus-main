...
import { getAllBusStops, updateLocation } from '../../controllers/user/user.controller.js';
import { getBusesByStops } from '../../controllers/admin/busStopsView.controller.js';
...
router.get('/getBusesByStops', getBusesByStops);
router.get('/getBusesBetweenStops', getBusesByStops);
