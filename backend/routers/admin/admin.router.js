...
import { 
  ...
  getBusLocation, getBusSchedule
} from '../../controllers/admin/admin.controllers.js';
import { 
  getBusStartTimes, addBusStartTime, updateStartTime, deleteStartTime 
} from '../../controllers/user/bus_time.controller.js';
import { getAllUserLocations } from '../../controllers/user/location.controller.js';
...
router.get('/buses/:id/schedule', getBusSchedule);
